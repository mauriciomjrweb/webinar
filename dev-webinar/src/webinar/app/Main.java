...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*Aluno aluno1 = new Aluno("123", "Mauricio", new Endereco("Tupi", "Alfenas"), "m@m.br");
		em.getTransaction().begin();
		em.persist(aluno1);
		em.getTransaction().commit();
		
		Instrutor instrutor1 = new Instrutor("Batman", new Endereco("Tupi", "Alfenas"), "bat@m.br", 1500, Formacao.JEDI);
		em.getTransaction().begin();
